...
import ovenues.com.ovenue.adapter.serviceprovider_details_page.ServiceProviderCateringChargesMenuAdapters.ServiceProviderBeveragesMenuAdapter;
...
import static ovenues.com.ovenue.ServiceProvidersDetailsMainFragment.beverages;

public class ServiceProviderBeveragesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutManager = new LinearLayoutManager(ServiceProviderBeveragesActivity.this);
        mRecyclerView.setLayoutManager(mLayoutManager);


        results = new ArrayList<ServiceProviderBeveragesActivity>();
        adapter = new ServiceProviderBeveragesMenuAdapter(results, ServiceProviderBeveragesActivity.this);

        mRecyclerView.setAdapter(adapter);

        // creating connection detector class instance
        ConnectionDetector cd = new ConnectionDetector(ServiceProviderBeveragesActivity.this);
        // get Internet status
        ...
        if (isInternetPresent) {
            ...
            Toast.makeText(ServiceProviderBeveragesActivity.this, "  No Internet Connection!!!.  ", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public class GetMenu extends AsyncTask<Object, Void, String> {
        ...
        protected void onPreExecute()//execute thaya pela
        {
            ...
            progressDialog = ProgressDialog.show(ServiceProviderBeveragesActivity.this, "Loading", "Please Wait...", true, false);
        ...
        protected void onPostExecute(String result) {
            ...
            try{
                ...
                JsonArray array_beverages_menu = beverages;
