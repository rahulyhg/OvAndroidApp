...
import static ovenues.com.ovenue.ServiceProviderCateringActivity.ServiceProviderFoodmenuSubCategory.service_food_guest_count;
...
public class ServiceProviderFoodMenuSubCategoryAdapter extends RecyclerView.Adapter<ServiceProviderFoodMenuSubCategoryAdapter
   ...
   /* public void setOnItemClickListener(MyClickListener myClickListener) {
    ...
    public ServiceProviderFoodMenuSubCategoryAdapter(ArrayList<FoodMenuModel> myDataset, Context context) {
        mDataset = myDataset;
        mContext=context;
    }
    ...
    public DataObject_postHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ServiceProviderFoodMenuSubCategoryAdapter.DataObject_postHolder dataObjectHolder = new ServiceProviderFoodMenuSubCategoryAdapter.DataObject_postHolder(view);
        return dataObjectHolder;
    }

    @Override
    public void onBindViewHolder(final ServiceProviderFoodMenuSubCategoryAdapter.DataObject_postHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mContext.startActivity(new Intent(mContext, ServiceProviderFoodAddItem.class)
                        .putExtra("course_id",mDataset.get(position).getMenu_id())
