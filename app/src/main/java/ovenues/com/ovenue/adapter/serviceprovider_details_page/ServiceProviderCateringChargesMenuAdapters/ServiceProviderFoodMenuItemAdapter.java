...
import static ovenues.com.ovenue.ServiceProviderCateringActivity.ServiceProviderFoodAddItem.selected_items_array;
...
public class ServiceProviderFoodMenuItemAdapter extends
        RecyclerView.Adapter<ServiceProviderFoodMenuItemAdapter.ViewHolder> {

    Context mContext;
    int checked_count=0;
    static private List<FoodMenuAddItemModel> stList;

    public ServiceProviderFoodMenuItemAdapter(Context context ,List<FoodMenuAddItemModel> students) {
    ...
    // Create new views
    @Override
    public ServiceProviderFoodMenuItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if(stList.get(position).getIs_additional_charges().equalsIgnoreCase("1")){
            ...
            viewHolder.tv_extra.setVisibility(View.GONE);
        }
