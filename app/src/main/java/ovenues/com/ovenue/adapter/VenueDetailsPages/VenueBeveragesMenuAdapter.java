...
public class VenueBeveragesMenuAdapter extends RecyclerView
        .Adapter<VenueBeveragesMenuAdapter
   ...
   /* public void setOnItemClickListener(MyClickListener myClickListener) {
    ...
    public VenueBeveragesMenuAdapter(ArrayList<FoodMenuModel> myDataset, Context context) {
        mDataset = myDataset;
        mContext=context;
    }
    ...
    public DataObject_postHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        VenueBeveragesMenuAdapter.DataObject_postHolder dataObjectHolder = new VenueBeveragesMenuAdapter.DataObject_postHolder(view);
        return dataObjectHolder;
    }

    @Override
    public void onBindViewHolder(final VenueBeveragesMenuAdapter.DataObject_postHolder holder, final int position) {
        ...
        holder.tv_addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(str_cart_id==null || str_cart_id.length()<1){
                    Toast.makeText(mContext,"Please add Date / Time /Guest .",Toast.LENGTH_SHORT).show();
    ...
    private class AddCartSPBeverages extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... parametros) {
            ...
            try {
                ...
                req.put("cart_id",Integer.parseInt(str_cart_id));
