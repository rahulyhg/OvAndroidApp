...
import ovenues.com.ovenue.adapter.VenueDetailsPages.CateringFoodMenu.VenueOrderCateringFoodMenuItemAdapter;
...
public class VenueCateringFoodAddItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Food Menu Item");
        ...
        mAdapter = new VenueOrderCateringFoodMenuItemAdapter(VenueCateringFoodAddItem.this,fooditemList);
        ...
        btnSelection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!getIntent().hasExtra("cart_ID")&& str_cart_id == null) {
                    Toast.makeText(VenueCateringFoodAddItem.this, "Date , Time and Guest Required .", Toast.LENGTH_LONG).show();
                }
                ...
                /*else if( et_address_line_SP_cateringCharge.getText().length()<0 ||
                    ...
                    if(guest_count==null || Integer.parseInt(guest_count)<1){
                        Toast.makeText(VenueCateringFoodAddItem.this,"Guest count required.",Toast.LENGTH_LONG).show();
                    }else {
                        String data = "";
                        List<FoodMenuAddItemModel> stList = ((VenueOrderCateringFoodMenuItemAdapter) mAdapter).getStudentist();
                        ...
                        new AddCartVenueCateringFood().execute();
    ...
    class GetMenu extends AsyncTask<Object, Void, String> {
        ...
        protected void onPreExecute()//execute thaya pela
        {
            ...
            progressDialog = ProgressDialog.show(VenueCateringFoodAddItem.this, "Loading", "Please Wait...", true, false);
                    ...
                    for (int j = 0; j < array_food_menu.size(); j++) {
                        ...
                        for (int k = 0; k < array_courses.size(); k++) {
                            ...
                            if (course_id.equalsIgnoreCase(str_course_id)) {
                                ...
                                tv_menutitle.setText(course_title+">"+menu_desc+"\n( MAX "+max_item_selectn_allowed+" items allowed.)");
        ...
        protected String doInBackground(Object... parametros) {
            try {
                ...
                if(getIntent().hasExtra("cart_ID")) {
                    String response = post(Const.SERVER_URL_API + "cart_catering_item_selected?cart_id=" + getIntent().getStringExtra("cart_ID") + "&menu_id=" + getIntent().getStringExtra("menu_id") + "&course_id=" + str_course_id, "", "get");
                    ...
                    String response = post(Const.SERVER_URL_API + "cart_catering_item_selected?cart_id=" + Integer.parseInt(str_cart_id) + "&menu_id=" + str_menu_id + "&course_id=" + str_course_id, "", "get");
                    Log.d("URL items====", Const.SERVER_URL_API + "cart_catering_item_selected?cart_id=" + Integer.parseInt(str_cart_id) + "&menu_id=" + str_menu_id + "&course_id=" + str_course_id);
                    response_items = response;
                }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (response_string.equals("success")) {
                    ...
                    Snackbar snackbar = Snackbar
                            .make(VenueCateringFoodAddItem.this.findViewById(android.R.id.content), message, Snackbar.LENGTH_LONG)
                            .setAction("OK", new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                }
    ...
    String response_string;
    private class AddCartVenueCateringFood extends AsyncTask<Object, Void, String> {
        ...
        protected void onPreExecute()//execute thaya pela
        {
            ...
            //inicia diálogo de progress, mostranto processamento com servidor.
            progressDialog2 = ProgressDialog.show(VenueCateringFoodAddItem.this, "", "Adding to cart...", true, false);
        ...
        protected String doInBackground(Object... parametros) {
            ...
            try {
                ...
                req.put("guest_count",guest_count);
        ...
        { if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.CUPCAKE) {
            ...
            if (response_string == null || response_string.equals("")) {
                ...
                progressDialog2.dismiss();
                Toast.makeText(VenueCateringFoodAddItem.this, "Network connection ERROR or ERROR", Toast.LENGTH_LONG).show();
                return;
            }
            try {
                ...
                if(response_string.equals("success")){
                    Snackbar snackbar = Snackbar
                            .make(VenueCateringFoodAddItem.this.findViewById(android.R.id.content), "Item Added to cart.", Snackbar.LENGTH_LONG);
                            /*.setAction("OK", new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                }
                    ...
                    Toast.makeText(VenueCateringFoodAddItem.this,"Item added to cart",Toast.LENGTH_LONG).show();
