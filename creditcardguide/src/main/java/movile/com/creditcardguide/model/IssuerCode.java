...
public enum IssuerCode implements Serializable {
    ...
    DISCOVER (R.string.discover, R.drawable.card_discover,  R.drawable.discover, R.drawable.discover_back, R.drawable.sign_diners, R.color.white, R.color.gray_hard_text),
    ...
    VISAELECTRON (R.string.visaelectron, R.drawable.card_visa,  R.drawable.visa, R.drawable.american_back, R.drawable.sign_visa, R.color.white, R.color.gray_hard_text),
